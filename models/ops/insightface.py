...
class IResNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.bn2 = nn.BatchNorm2d(512 * block.expansion, eps=1e-05, momentum=0.9)
        self.dropout = nn.Dropout2d(p=0.4, inplace=True)
        self.fc = nn.Linear(512 * block.expansion * self.fc_scale, num_features)
        self.features = nn.BatchNorm1d(num_features, eps=1e-05, momentum=0.9)
...
def iresnet10(pretrained=False, progress=True, **kwargs):
    return _iresnet('iresnet34', IBasicBlock, [1, 1, 1, 1], pretrained, progress,
                    **kwargs)

def iresnet18(pretrained=False, progress=True, **kwargs):
    return _iresnet('iresnet34', IBasicBlock, [2, 2, 2, 2], pretrained, progress,
                    **kwargs)
